...
RUN apt-get update
RUN apt-get install -y python-tk wget graphviz libtiff5-dev libjpeg8-dev zlib1g-dev libfreetype6-dev liblcms2-dev libwebp-dev tcl8.6-dev tk8.6-dev python-gdal gdal-bin python3-gdal
RUN pip install matplotlib keras pydot graphviz keras-vis opencv-python unicodecsv pyproj requests imbalanced-learn boto boto3
